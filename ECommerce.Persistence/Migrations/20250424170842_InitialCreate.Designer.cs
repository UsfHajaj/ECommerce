...
namespace ECommerce.Persistence.Migrations
{
    ...
    [Migration("20250424170842_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.Payments.Shipping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.Identity.Address", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.Identity.ApplicationUser", "ApplicationUser")
                        .WithOne("Address")
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.Payments.Payment", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.Orders.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("ECommerce.Domain.Entities.Payments.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.Payments.Shipping", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.Orders.Order", "Order")
                        .WithOne("Shipping")
                        .HasForeignKey("ECommerce.Domain.Entities.Payments.Shipping", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
